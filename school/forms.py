...
class CreateAppFormSchool(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'phone_number': TextInput(attrs={'placeholder': '+38XXXXXXXXXX'}),
            'email': TextInput(attrs={'placeholder': 'email@example.com'}),
            'city': Select(attrs={'id': 'id_school_page_city'}),
            'driverschoolunit': Select(attrs={'id': 'id_school_page_driverschoolunit'}),
            'course': Select(attrs={'id': 'id_school_page_course'}),
        }
