# Generated by Django 4.1 on 2022-08-19 11:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image1', models.ImageField(default='schoolua/images/test-image1.jpg', upload_to='school/images/', verbose_name='Фото головне')),
                ('image2', models.ImageField(default='schoolua/images/test-image2.jpg', upload_to='school/images/', verbose_name='Фото 2')),
                ('image3', models.ImageField(default='schoolua/images/test-image3.jpg', upload_to='school/images/', verbose_name='Фото 3')),
                ('image4', models.ImageField(default='schoolua/images/test-image4.jpg', upload_to='school/images/', verbose_name='Фото 4')),
                ('image5', models.ImageField(default='schoolua/images/test-image5.jpg', upload_to='school/images/', verbose_name='Фото 5')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(blank=True, max_length=400, verbose_name='Геопозиція автошколи')),
                ('contact', models.CharField(max_length=200, verbose_name='Контактний номер тел.')),
                ('category', models.ManyToManyField(blank=True, to='school.category', verbose_name='Категорії')),
                ('city_of_unit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.city', verbose_name='Місто')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.city', verbose_name='Місто')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.courses', verbose_name='Курс')),
                ('driverschoolunit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.driverschoolunit', verbose_name='Філія автошколи')),
            ],
            options={
                'verbose_name': 'Заявка',
